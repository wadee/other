	...
	Pi: function() {
		...
		$.ajax({
			...
			success: function(data) {
					   ...
					   if(info.score >= 500)
					   {
						  b = _.sprintf("你把金融街盖到了%d层，和【%s】一样高，你当前累计排名%d，要加油哦！", a, y.c.Gf(), info.rank);
					   }
					   else
					   {
							b = _.sprintf("你已经把金融街盖到了%d层，恭喜你本次赢得了%1f元代金券，请持续努力盖楼获得更多代金券哦~", a, a/10);
					   }
		...
		A.Ia("end", "score", a);
			...
			function() {
				location.href="rank.php?mobile="+getQueryString("mobile");
			}.bind(this),"下载使用代金券",
			function() {
